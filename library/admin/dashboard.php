...
<head>
    ...
    <style>
     ...
     .header-line {
      ...
      .alert.alert-success.back-widget-set.text-center {
        background: #b8e994;
     }
     .alert.alert-success.back-widget-set.text-center:hover{
         background:none;
     }
     .alert.alert-info.back-widget-set.text-center {
        background: #4a69bd5c;
     }
     .alert.alert-info.back-widget-set.text-center:hover {
        background: none;
     }
     .alert.alert-warning.back-widget-set.text-center {
        background: #f8c2914a;
     }
     .alert.alert-warning.back-widget-set.text-center:hover {
        background: none;
     }
     .alert.alert-danger.back-widget-set.text-center {
        background: #b7154017;
    }
    .alert.alert-danger.back-widget-set.text-center:hover {
       background: none;
   }
   .footer-section {
