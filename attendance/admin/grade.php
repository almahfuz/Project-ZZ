...
<div class="container" style="margin-top:30px">
  <div class="card">
      ...
      <div class="row">
        <div class="col-md-9">Semester-Section</div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group">
            <div class="row">
              <label class="col-md-4 text-right">Semester-Section<span class="text-danger">*</span></label>
              <div class="col-md-8">
...
$(document).ready(function(){
  ...
  $('#add_button').click(function(){
    $('#modal_title').text('Add Semester-Section');
